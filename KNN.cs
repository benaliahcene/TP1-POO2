    ...
    public List<Heart> GetDataFromCsv(string filename)
    {
        ...
        using (var csv = new CsvReader(reader, CultureInfo.InvariantCulture))
        {
            ...
            while (csv.Read())
            {
                ...
                float[] features = {
                  float.Parse(csv.GetField("cp"),CultureInfo.InvariantCulture.NumberFormat),
                    float.Parse(csv.GetField("thal"),CultureInfo.InvariantCulture.NumberFormat),
                    float.Parse(csv.GetField("ca"), CultureInfo.InvariantCulture.NumberFormat),
                    float.Parse(csv.GetField("oldpeak"), CultureInfo.InvariantCulture.NumberFormat),
                    float.Parse(csv.GetField("thalach"), CultureInfo.InvariantCulture.NumberFormat)
                };
